...
public class GestionAbonneFrame extends javax.swing.JFrame {
    ...
    private void modifierAbonne() {
        ...
        try {
            ...
            Abonne abonne = new Abonne(id, txtNom.getText().trim(),
                    txtPrenom.getText().trim(), txtEmail.getText().trim(), txtTelephone.getText().trim());
    ...
    private void supprimerAbonne() {
        ...
        try {
            ...
            int rep = JOptionPane.showConfirmDialog(this,
                    "Supprimer l'abonné ID " + id + " ?", "Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    private void rechercherAbonne() {
        String idStr = JOptionPane.showInputDialog(this, "Entrez l'ID de l'abonné :", "Recherche", JOptionPane.QUESTION_MESSAGE);
